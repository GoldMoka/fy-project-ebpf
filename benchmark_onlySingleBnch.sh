...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --only-b2)     ONLY_B2=true;           shift   ;;
        --only-b3)     ONLY_B3=true;           shift   ;;
        --only-b4)     ONLY_B4=true;           shift   ;;
        --only-b5)     ONLY_B5=true;           shift   ;;
        --only-b6)     ONLY_B6=true;           shift   ;;
        --only-b7)     ONLY_B7=true;           shift   ;;
        --only-b8)     ONLY_B8=true;           shift   ;;
        --only-b9)     ONLY_B9=true;           shift   ;;
        --only-b10)    ONLY_B10=true;          shift   ;;
        *) die "Unknown option: $1" ;;
    esac
done

# ── Optional single-benchmark selection ───────────────────────────────────────
ONLY_COUNT=0
[[ "$ONLY_B1"  == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))
[[ "$ONLY_B2"  == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))
[[ "$ONLY_B3"  == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))
[[ "$ONLY_B4"  == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))
[[ "$ONLY_B5"  == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))
[[ "$ONLY_B6"  == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))
[[ "$ONLY_B7"  == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))
[[ "$ONLY_B8"  == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))
[[ "$ONLY_B9"  == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))
[[ "$ONLY_B10" == true ]] && ONLY_COUNT=$((ONLY_COUNT + 1))

(( ONLY_COUNT <= 1 )) || die "Use only one --only-bN option at a time"

SELECTED_BENCHMARK="all"
[[ "$ONLY_B1"  == true ]] && SELECTED_BENCHMARK="B1"
[[ "$ONLY_B2"  == true ]] && SELECTED_BENCHMARK="B2"
[[ "$ONLY_B3"  == true ]] && SELECTED_BENCHMARK="B3"
[[ "$ONLY_B4"  == true ]] && SELECTED_BENCHMARK="B4"
[[ "$ONLY_B5"  == true ]] && SELECTED_BENCHMARK="B5"
[[ "$ONLY_B6"  == true ]] && SELECTED_BENCHMARK="B6"
[[ "$ONLY_B7"  == true ]] && SELECTED_BENCHMARK="B7"
[[ "$ONLY_B8"  == true ]] && SELECTED_BENCHMARK="B8"
[[ "$ONLY_B9"  == true ]] && SELECTED_BENCHMARK="B9"
[[ "$ONLY_B10" == true ]] && SELECTED_BENCHMARK="B10"
...
# =============================================================================
if should_run_benchmark "B1"; then
...
if should_run_benchmark "B2"; then
...
if should_run_benchmark "B3"; then
...
if should_run_benchmark "B4"; then
...
if should_run_benchmark "B5"; then
...
if should_run_benchmark "B6"; then
...
if should_run_benchmark "B7"; then
# B7 — Memory footprint
# =============================================================================
...
if should_run_benchmark "B8"; then
# B8 — CPU overhead
# =============================================================================
hdr "B8 — CPU overhead (%)"
...
if should_run_benchmark "B9"; then
...
if should_run_benchmark "B10"; then
# B10 — EWMA convergence (windows until threshold stabilises)
# =============================================================================
...
# Final summary
# =============================================================================
if [[ "$SELECTED_BENCHMARK" == "all" ]]; then
    hdr "All benchmarks complete"
else
    hdr "${SELECTED_BENCHMARK} benchmark complete"
fi
